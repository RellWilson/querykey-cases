...
class UsageSelf(BaseModel):
    ...
    plan: StrictStr
    limits: Dict[str, Any]
    usage: List[UsageSelfUsageInner]
    reset_at: datetime
    __properties: ClassVar[List[str]] = ["date", "plan", "limits", "usage", "reset_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usage": [UsageSelfUsageInner.from_dict(_item) for _item in obj["usage"]] if obj.get("usage") is not None else None,
