...
class PlanUpgradeRequired(BaseModel):
    """
    PlanUpgradeRequired
    """ # noqa: E501
    error: StrictStr
    required_feature: StrictStr
    current_plan: StrictStr
    __properties: ClassVar[List[str]] = ["error", "required_feature", "current_plan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": obj.get("error"),
            "required_feature": obj.get("required_feature"),
