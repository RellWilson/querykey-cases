...
class DelegatedTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    delegated_token: StrictStr = Field(description="Secret token value (single use)")
    expires_at: datetime = Field(description="Expiration timestamp in ISO-8601")
    scopes: List[StrictStr] = Field(description="Granted scopes (always agent:register for v1.0)")
    __properties: ClassVar[List[str]] = ["delegated_token", "expires_at", "scopes"]
