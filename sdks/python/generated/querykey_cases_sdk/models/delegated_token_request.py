...
class DelegatedTokenRequest(BaseModel):
    ...
    """ # noqa: E501
    expires_in: Optional[Any] = Field(default=None, description="Requested TTL in seconds; server enforces configured bounds")
    scopes: Optional[List[StrictStr]] = Field(default=None, description="Optional scopes list; only agent:register is currently supported")
    __properties: ClassVar[List[str]] = ["expires_in", "scopes"]
