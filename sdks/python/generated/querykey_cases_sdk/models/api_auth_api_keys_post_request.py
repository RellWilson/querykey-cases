...
class ApiAuthApiKeysPostRequest(BaseModel):
    """
    ApiAuthApiKeysPostRequest
    """ # noqa: E501
    label: Optional[StrictStr] = None
    scopes: Optional[List[StrictStr]] = Field(default=None, description="Optional scopes to associate with key")
    __properties: ClassVar[List[str]] = ["label", "scopes"]
