...
class ApiBillingCheckoutPostRequest(BaseModel):
    """
    ApiBillingCheckoutPostRequest
    """ # noqa: E501
    plan: StrictStr
    billing_cycle: Optional[StrictStr] = 'monthly'
    __properties: ClassVar[List[str]] = ["plan", "billing_cycle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plan": obj.get("plan"),
            "billing_cycle": obj.get("billing_cycle") if obj.get("billing_cycle") is not None else 'monthly'
        })
        return _obj
