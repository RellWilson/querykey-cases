...
class AgentInviteConfirmationRequest(BaseModel):
    """
    AgentInviteConfirmationRequest
    """ # noqa: E501
    token: StrictStr = Field(description="Invite token delivered via email")
    invite_token: Optional[Any] = Field(default=None, description="Alias for token supported for backward compatibility")
    __properties: ClassVar[List[str]] = ["token", "invite_token"]
