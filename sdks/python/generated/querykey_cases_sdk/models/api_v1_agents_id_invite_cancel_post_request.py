...
class ApiV1AgentsIdInviteCancelPostRequest(BaseModel):
    """
    ApiV1AgentsIdInviteCancelPostRequest
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="Optional cancellation reason captured for audit trails")
