...
class ApiAuthApiKeysGet200Response(BaseModel):
    """
    ApiAuthApiKeysGet200Response
    """ # noqa: E501
    keys: Optional[List[ApiAuthApiKeysGet200ResponseKeysInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [ApiAuthApiKeysGet200ResponseKeysInner.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None
        })
        return _obj
