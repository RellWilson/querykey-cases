...
class AgentRegistrationOwner(BaseModel):
    """
    AgentRegistrationOwner
    """ # noqa: E501
    name: Optional[Any] = Field(default=None, description="Owner display name used in invite email")
    email: StrictStr = Field(description="Owner email address that will receive the invite")
