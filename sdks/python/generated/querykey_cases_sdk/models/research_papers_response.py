...
class ResearchPapersResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[ResearchPaperSummary]] = None
    meta: Optional[CollectionsResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ResearchPaperSummary.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "meta": CollectionsResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
